...
HD_PWD='C:/Users/yasin/Desktop/dpu_design_ip/dpu_design_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zedboard_dpu_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zedboard_dpu_wrapper.tcl -notrace
