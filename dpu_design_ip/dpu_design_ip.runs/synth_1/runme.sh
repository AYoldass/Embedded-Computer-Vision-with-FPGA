...
HD_PWD='C:/Users/yasin/Desktop/dpu_design_ip/dpu_design_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zedboard_dpu_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zedboard_dpu_wrapper.tcl
