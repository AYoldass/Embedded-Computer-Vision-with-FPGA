...
HD_PWD='C:/Users/yasin/Desktop/dpu_design_ip/dpu_design_ip.runs/zedboard_dpu_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zedboard_dpu_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zedboard_dpu_proc_sys_reset_0_0.tcl
